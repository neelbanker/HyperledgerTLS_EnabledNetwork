...
peer chaincode instantiate -o orderer.product.com:7050 --tls --cafile /opt/gopath/src/github.com/hyperledger/fabric/peer/crypto/ordererOrganizations/product.com/orderers/orderer.product.com/msp/tlscacerts/tlsca.product.com-cert.pem -C mychannel -n taskchaincode -v 1.0 -c '{"Args":["init"]}' -P "OR('ManufacturerMSP.member','RetailerMSP.member')" --collections-config  $GOPATH/src/github.com/chaincode/taskchaincode/collections_config.json
...
peer chaincode invoke -o orderer.product.com:7050 --tls --cafile /opt/gopath/src/github.com/hyperledger/fabric/peer/crypto/ordererOrganizations/product.com/orderers/orderer.product.com/msp/tlscacerts/tlsca.product.com-cert.pem -C mychannel -n taskchaincode -c '{"Args":["initProduct"]}'  --transient "{\"product\":\"$PRODUCT\"}"
